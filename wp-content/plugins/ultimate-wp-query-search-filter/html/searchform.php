...
if($formtitle){
	echo '<div class="uform_title"><div>'.get_the_title($id).'</div></div>';
}
...
if($button && $button == '1'){
$html = '<span class="'.$defaultclass.' '.$divclass.' uwpqsf_submit">';
$html .= '<input type="'.$btype.'" id="'.$divid.'_btn" value="'.$options[0]['button'].'" alt="[Submit]" class="usfbtn '.$bclass.'" /></span></div>';
